...
const TodaysMenuItem = ({ item, onAddItem, onRemoveItem, quantity }: TodaysMenuItemProps) => {
        ...
        <TodaysMenuItemContainer>
            ...
            <TodaysMenuFoodImageContainer>
                ...
                {quantity === 0 ? (
                    <TodaysMenuFoodAddButton>
                        ADD
                        <PlusIcon width="8" height="8" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={handleAddClick}>
                            <path
                    ...
                    <CountContainer>
                        <TodaysMenuFoodCountButton onClick={handleMinusClick}>
                            ...
                            >
                                <path d="M1.66675 4.00008H6.33341" stroke="#CA8A04" strokeLinecap="round" strokeLinejoin="round" />
                            </MinusIcon>
                        </TodaysMenuFoodCountButton>
                        <span>{quantity}</span>
